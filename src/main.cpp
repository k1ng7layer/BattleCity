...
int main(void)
{
    ...
    std::string vertex_shaderCode(vertex_shader);
    std::string fragment_shaderCode(fragment_shader);
    Renderer::ShaderProgram shaderProgram(vertex_shaderCode, fragment_shaderCode);
